...
public abstract class Abs_VisualNumber : MonoBehaviour
{
    public int myValue;

    // Color Bank. Not all are used.
    ...
    public abstract void SetMyColor(Color color);
    public void SetMyColor(int value)
    {
        SetMyColor(ValueToColor(value));
    }
